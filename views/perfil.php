    ...
    <section class="perfil-topo">
        ...
        <div class="perfil-identidade">
            <div class="perfil-avatar-wrap">
                <img src="../img/User.png" alt="Foto de Matheus Alves" class="perfil-avatar">
            ...
            <div class="perfil-identidade-texto">
                ...
                <h2>Matheus Alves</h2>
                <p><i class="bi bi-geo-alt"></i> Iguatu, Ceará <span></span> Membro desde junho de 2026</p>
            </div>
            <div class="perfil-pontos">
                <i class="bi bi-trophy-fill"></i>
                <div><span>Pontuação</span><strong>1.240</strong><small>12º no ranking</small></div>
            </div>
        </div>
    </section>
    ...
    <main class="perfil-conteudo">
        <div class="perfil-tabs-wrap">
            <div class="perfil-tabs" role="tablist" aria-label="Seções do perfil">
                ...
                <button class="perfil-tab" id="tab-doacoes" type="button" role="tab" aria-selected="false" aria-controls="painel-doacoes" data-aba="doacoes">
                    <i class="bi bi-box-seam"></i><span>Minhas doações</span><b>1</b>
                </button>
                <button class="perfil-tab" id="tab-adocoes" type="button" role="tab" aria-selected="false" aria-controls="painel-adocoes" data-aba="adocoes">
                    <i class="bi bi-handbag"></i><span>Minhas adoções</span><b>0</b>
                </button>
        ...
        <section class="perfil-painel ativo" id="painel-visao" role="tabpanel" aria-labelledby="tab-visao" data-painel="visao">
            ...
            <div class="perfil-estatisticas">
                <article class="perfil-stat stat-doacoes">
                    ...
                    <div><span>Itens doados</span><strong>1</strong><small>1 disponível</small></div>
                </article>
                <article class="perfil-stat stat-adocoes">
                    <div class="perfil-stat-icone"><i class="bi bi-handbag"></i></div>
                    <div><span>Itens adotados</span><strong>0</strong><small>Nenhuma adoção</small></div>
                </article>
                <article class="perfil-stat stat-reservas">
                    <div class="perfil-stat-icone"><i class="bi bi-clock-history"></i></div>
                    <div><span>Reservas pendentes</span><strong>0</strong><small>Tudo em dia</small></div>
                </article>
            </div>
            ...
            <div class="perfil-resumo-grid">
                <section class="perfil-bloco">
                    ...
                    <article class="doacao-resumo">
                        <img src="../asset/img/celulares.webp" alt="Celular Motorola Moto G">
                        <div class="doacao-resumo-info">
                            <span class="status-disponivel">Disponível</span>
                            <h4>Celular Motorola Moto G</h4>
                            <p>Tela com marcas de uso, aparelho funcionando normalmente.</p>
                            <small><i class="bi bi-calendar3"></i> Publicado em 18/06/2026</small>
                        </div>
                    </article>
                </section>
                ...
                <aside class="perfil-impacto">
                    ...
                    <h3>Você já evitou cerca de</h3>
                    <strong>0,18 kg</strong>
                    <p>de lixo eletrônico descartado de forma inadequada.</p>
                    <div class="impacto-progresso"><span style="width: 42%"></span></div>
        ...
        <section class="perfil-painel" id="painel-doacoes" role="tabpanel" aria-labelledby="tab-doacoes" data-painel="doacoes" hidden>
            <div class="perfil-secao-titulo">
                ...
                <a href="#" class="perfil-acao-primaria"><i class="bi bi-plus-lg"></i> Nova doação</a>
            </div>
            <div class="doacoes-lista">
                <article class="doacao-item">
                    <img src="../asset/img/celulares.webp" alt="Celular Motorola Moto G">
                    <div class="doacao-item-info">
                        <div><span class="status-disponivel">Disponível</span><small>Publicado em 18/06/2026</small></div>
                        <h3>Celular Motorola Moto G</h3>
                        <p>Tela com marcas de uso, aparelho funcionando normalmente.</p>
                        <span class="doacao-local"><i class="bi bi-geo-alt"></i> Iguatu, CE</span>
                    </div>
                    <div class="doacao-acoes">
                        <button type="button" title="Editar doação" aria-label="Editar doação"><i class="bi bi-pencil"></i></button>
        ...
        <section class="perfil-painel" id="painel-editar" role="tabpanel" aria-labelledby="tab-editar" data-painel="editar" hidden>
            ...
            <form id="form-perfil" class="perfil-formulario">
                <div class="campo-perfil campo-largo">
                    ...
                    <input id="perfil-nome" name="nome" type="text" value="Matheus Alves" required>
                </div>
                <div class="campo-perfil">
                    <label for="perfil-email">E-mail</label>
                    <input id="perfil-email" name="email" type="email" value="matheus.alves@email.com" required>
                </div>
                <div class="campo-perfil">
                ...
                <div class="campo-perfil">
                    ...
                    <input id="perfil-cidade" name="cidade" type="text" value="Iguatu">
                </div>
                <div class="campo-perfil">
